import 'package:casaccountmanagement/util/network_authentication.dart';
import 'package:casaccountmanagement/util/validation.dart';
import 'package:casaccountmanagement/widget/custom_profile.dart';
import 'package:casaccountmanagement/widget/custom_textfield.dart';
              ...
              children: [
                                 ...
                                 if (cnicGlobalKey.currentState!.validate()) {
                                   ...
                                   if(  widget.userStatus.toString().contains('SuperAdmin') ) {
                                     ...
                                     studentCourseEnrollmentDOCS =
                                         ...
                                         controllerCNIC.text.toString().trim())
                                         .get();
                                   }else{
                                     studentCourseEnrollmentDOCS =
                                         await DBHandler
                                         .studentCourseEnrollmentCollectionWithUserUID(
                                         controllerCNIC.text.toString(),widget.userStatus![2].toString())
                                         .get();
                                   ...
                                   for (int docsCount = 0;
                                   docsCount <
                                       studentCourseEnrollmentDOCS.docs.length;
                                   docsCount++) {
                                     var singleCourseFee =
                                     studentCourseEnrollmentDOCS
                                         .docs[docsCount];
                                     ...
                                     DateTime datePicker = DateTime(
                                         int.parse(startingDate.substring(0, 4)),
                                         int.parse(startingDate.substring(5, 7)),
                                         int.parse(startingDate.substring(8, 10)));
                                     ...
                                     if (currentDate
                                       ...
                                       installmentCount <
                                           singleCourseFee[ModelFeeStructure
                                               .minInstallmentKey];
                                       installmentCount++) {
                                         var instalmentDate = DateTime(
                                             datePicker.year,
                                             datePicker.month + (installmentCount),
                                             installmentCount == 0
                                                 ? datePicker.day
                                                 : 1);
                                         print(
                                             '.................$instalmentDate.........................');
                                         if (currentDate.isAfter(instalmentDate)) {
                                           print(
                                               '....................$currentDate,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,');
                                           outStandingList[installmentCount + 1] =
                                               outStandingList[installmentCount] +
                                                   outStandingList[
                                                   installmentCount + 1];
                                           outStandingList[installmentCount] = 0.0;
                ...
                check == true
                    ? StreamBuilder<QuerySnapshot>(
                        stream:  widget.userStatus.toString().contains('SuperAdmin') ? DBHandler.studentCourseEnrollmentCollection(
                                controllerCNIC.text.toString())
                            .snapshots() :DBHandler.studentCourseEnrollmentCollectionWithUserUID(
                            controllerCNIC.text.toString(),widget.userStatus![2].toString())
                            .snapshots(),
                        builder: (context,
                                                                                          ...
                                                                                          onPressed: () async {
                                                                                            ...
                                                                                            if(  widget.userStatus.toString().contains('SuperAdmin') ) {
                                                                                              DBHandler
                                                                                                  ...
                                                                                                  {
                                                                                                    ModelFeeStructure
                                                                                                        .outStandingKey: installmentPaidList,
                                                                                                    ModelFeeStructure
                                                                                                        .paidStatusKey: paidStatusList
                                                                                                  });
                                                                                              ...
                                                                                              var paidFeeHistory = ModelFeeVoucher(
                                                                                                ...
                                                                                                installment: index
                                                                                                    .toString(),
                                                                                                courseName: singleCourseFeeInfo[ModelFeeStructure
                                                                                                    .titleKey],
                                                                                                cnic: controllerCNIC
                                                                                                    .text
                                                                                                    .toString(),
                                                                                                amount:  double.parse(singleCourseFeeInfo[ModelFeeStructure
                                                                                                    .outStandingKey][index -
                                                                                                    1].toString()),
                                                                                                date: dateToday
                                                                                                    .toString()
                                                                                              ...
                                                                                              DBHandler
                                                                                                  ...
                                                                                                  controllerCNIC
                                                                                                      .text
                                                                                                      .toString(),widget.userStatus![2].toString())
                                                                                                  .doc(
                                                                                                  singleCourseFeeInfo[ModelFeeStructure
                                                                                                      .titleKey])
                                                                                                  .update(
                                    ...
                                    child: CustomVoucher.customVoucher(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if(widget.userStatus.toString().contains('SuperAdmin') ) {
                                          ...
                                          DBHandler.feeHistoryCollectionWithUserUID(widget.userStatus![2].toString())
                                              .doc('$dateToday')
                                              .set(paidFeeHistory.toMap());
