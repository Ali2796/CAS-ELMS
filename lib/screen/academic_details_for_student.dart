...
class AcademicDetailsForStudent extends StatefulWidget {
  ...
  const AcademicDetailsForStudent({Key? key, required this.cnic, required this.userUID})
      : super(key: key);
...
class _AcademicDetailsForStudentState extends State<AcademicDetailsForStudent> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          child: SizedBox(
            width: kIsWeb ?MediaQuery.of(context).size.width*0.6 :MediaQuery.of(context).size.width,
            child: StreamBuilder<QuerySnapshot>(
              stream: DBHandler.studentCourseEnrollmentCollectionWithUserUID(widget.cnic,widget.userUID)
                  .snapshots(),
