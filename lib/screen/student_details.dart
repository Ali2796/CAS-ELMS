import 'package:casaccountmanagement/provider/ModelFeeStructure.dart';
import 'package:casaccountmanagement/widget/bnb_for_student_enrollment.dart';
    ...
    if (widget.userStatus![0].toString() == 'SuperAdmin') {
      for (var item in selectMultipleItemsProvider.list) {
        ...
        DBHandler.groupStudentCollection(widget.userStatus![1])
            ...
            .delete().catchError((error) => ScaffoldMessenger.of(context)
            .showSnackBar(const SnackBar(
            backgroundColor: Colors.red,
            content: Text('Something went Wrong'))));
            //.then((value) {
        ...
        if (studentCourseEnrollmentCollection.docs.length > 1) {
          ...
          DBHandler.studentRegistrationWithUID(
              ...
              .doc(item[ModelAddStudent.cnicKey])
              .delete();
          DBHandler.studentCollection().doc(item[ModelAddStudent.cnicKey]).delete();
