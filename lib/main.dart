...
import 'package:casaccountmanagement/provider/carousel_counter.dart';
import 'package:casaccountmanagement/provider/model_add_student.dart';
import 'package:casaccountmanagement/screen/dashboard.dart';
import 'package:casaccountmanagement/screen/first_intro.dart';
import 'package:casaccountmanagement/util/item_select_check.dart';
import 'package:casaccountmanagement/util/item_select_check_for_students.dart';
import 'package:casaccountmanagement/widget/bnb_for_student_detail.dart';
...
void main() async {
  ...
  if(kIsWeb){
    await Firebase.initializeApp(
        options: const FirebaseOptions(apiKey: "AIzaSyBLCRgHOhATI3KHUbyuoWrUtV-RL67GBEQ",
                  ...
                  return FutureBuilder(
                    ...
                    builder: (context,
                      ...
                      if (sharePrefSnapshot.hasData) {
                        ...
                        print(
                            '........................else......................');
                        return const MyDashBoard(userStatus: 'SuperAdmin',);
                      }
                    },
                  );
                } else {
